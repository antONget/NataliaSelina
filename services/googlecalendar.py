...
# calendar_id = 'a.l.ponomarev1989@gmail.com'
# obj.add_calendar(calendar_id='a.l.ponomarev1989@gmail.com')

# time_dict = {"H1": 14, "M1": 40, "H2": 15, "M2": 20}
# obj.create_event(time_dict=time_dict, summary='Записи на консультацию Тестовая', description='Проверка работы')
# pprint.pprint(obj.get_calendar_list())
